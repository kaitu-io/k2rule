// k2rule-gen: CLI tool for generating K2RULEV2 binary rule files.
//
// Usage:
//
...
// filters heuristic-detected domains, builds a K2RULEV2 with target=Reject,
...
// converts to K2RULEV2 format, gzip-compresses, and writes .k2r.gz files.
...
// domains, builds a K2RULEV2 with target=Reject, and writes a .k2r.gz file.
func generatePorn(outputPath string, verbose bool) error {
	...
	// Step 5: Build K2RULEV2 with target=Reject (2)
	...
	logger.Info("Built K2RULEV2 binary", "size_bytes", len(data))
